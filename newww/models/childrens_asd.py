   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Fold: 5\n",
      "Accuracy: 0.8960674157303371\n",
      "Mean accuracy across all folds: 0.9106741573033708\n"
     ]
    }
   ],
   "source": [
    ...
    "df=pd.read_csv(\"C:\\\\Users\\\\nagas\\\\OneDrive\\\\Documents\\\\project\\\\archive (1)\\\\archive (1)\\\\archive\\\\childrens_asd.csv\")\n",
    ...
    "pickle.dump(rfclassifier,open(\"childrenmodel.pkl\",\"wb\"))\n",
    "model=pickle.load(open('childrenmodel.pkl','rb'))"
   ]
  }
 ],
 "metadata": {
