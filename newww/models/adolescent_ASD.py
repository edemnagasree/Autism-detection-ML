   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Mean accuracy across all folds: 0.8211694152923539\n"
     ]
    }
   ],
   "source": [
    ...
    "df=pd.read_csv(\"C:\\\\Users\\\\nagas\\\\OneDrive\\\\Documents\\\\project\\\\archive (1)\\\\archive (1)\\\\archive\\\\adolescent_ASD.csv\")\n",
    ...
    "columns_to_drop = ['Unnamed: 0','Sex','Who_completed_the_test_Others', 'Who_completed_the_test_School and NGO', 'Who_completed_the_test_Self','Ethnicity']\n",
    ...
    "pickle.dump(rfclassifier,open(\"adolescentmodel.pkl\",\"wb\"))\n",
    "model=pickle.load(open('adolescentmodel.pkl','rb'))"
   ]
  }
 ],
 "metadata": {
